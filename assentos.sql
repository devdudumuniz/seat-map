...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13/05/2023 às 20:42
...
INSERT INTO `assentos` (`id_assento`, `id_usua`, `id_cadeira`) VALUES
(47, 1, 1);
...
--
ALTER TABLE `assentos`
  MODIFY `id_assento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
COMMIT;
